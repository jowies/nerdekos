          ...
          <div className="" style={{ float: 'left', width: '100%' }}>
            <div className="center center-text">
              <div style={{ display: 'inline-block' }}>
                {!this.getSize() ?
                  <h1
                    className="center-text center mdl-color-text--grey-100"
                ...
                <h6
                  className="mdl-color-text--grey-100"
                  style={{ lineHeight: 2, marginTop: 0, textAlign: 'right', marginBottom: 40 }}
                >BY JOWIE</h6>
              </div>
            </div>
          </div>
